...
import { approval, values } from '../content/site'
...
export default function LandingPage() {
  return <>
    ...
    <section className="section overview-section container" aria-labelledby="overview-title">
      ...
      <nav className="overview-links" aria-label="Læs mere om Stjernestøv"><TextLink to="/om-os">Læs om Stjernestøv</TextLink><TextLink to="/faglig-tilgang">Se vores faglige tilgang</TextLink><TextLink to="/hverdagen">Læs om hverdagen hos os</TextLink></nav>
    </section>
