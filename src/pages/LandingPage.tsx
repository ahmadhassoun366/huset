...
export default function LandingPage() {
  return <>
    ...
    <section className="home-hero" aria-labelledby="hero-title">
      ...
      <div className="hero-photo"><img src="/images/house1.jfif" alt="Huset Stjernestøvs rødstenshus med låge og gårdsplads i Forlev" width="1600" height="1195" fetchPriority="high" /><div className="photo-label"><Star /><span>HUSET STJERNESTØV<small>Forlev · Skanderborg</small></span></div></div>
    </section>
