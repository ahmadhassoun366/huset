...
export default function ContactPage() {
  return <>
    ...
    <div className="contact-page-main">
      ...
      <section className="contact-facts" aria-label="Virksomhedsoplysninger"><div className="container contact-facts-inner"><div className="contact-facts-item contact-facts-name"><span className="star" aria-hidden="true">✦</span><span>Huset Stjernestøv ApS</span></div><div className="contact-facts-item"><dt>Adresse</dt><dd>{site.address}</dd></div><div className="contact-facts-item"><dt>CVR</dt><dd>{site.cvr}</dd></div><div className="contact-facts-item"><dt>E-mail</dt><dd><a href={`mailto:${site.email}`}>{site.email}</a></dd></div></div></section>
